...
anos_sexoGraf$yAxis(title = list(text = "SDFJSDFJ"))
anos_sexo
...
data_anos_grauEscola[1,3] <-summarise(filter(data_cg2000, GRAU_DE_ESCOLARIDADE), sum(QTD_ELEITORES_NO_PERFIL))[1,1]
...
anos_grausGraf$yAxis(title = list(text = "SDFJSDFJ"))
anos_graus
